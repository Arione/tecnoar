...
/**
 * Esta classe irá te ajudar a alterar as propriedades de uma tabela.
 * @author Arione Guedes dos Santos Junior
 */
public class TableModelNaoEditavel extends AbstractTableModel implements Serializable {
...
//
     ...
     * @see #setValueAt
     */
    public TableModelNaoEditavel(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public TableModelNaoEditavel(Vector columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public TableModelNaoEditavel(Object[] columnNames, int rowCount) {
     ...
     * @see #setDataVector
     */
    public TableModelNaoEditavel(Vector data, Vector columnNames) {
     ...
     * @see #setDataVector
     */
    public TableModelNaoEditavel(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
...
// 
    ...
    /**
     * Adiciona uma linha no final da Tabela.
     * @param   rowData Um <code>Vector</code> com o número correto de colunas
     */
    ...
    /**
     * Adiciona uma linha no final da Tabela.
     * @param   rowData Um vetor de objetos com o número correto de colunas
     */
    ...
    /**
     *  Remove uma linha do TableModel
     * @param  row Index da linha a ser removida
     * @exception  ArrayIndexOutOfBoundsException  Se a o index for inválido
     */
...
// 
    ...
    /**
     *  Adiciona uma Coluna no TableModel
     * @param   columnName O nome para identificação da coluna.
     */
